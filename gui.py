...
class MainFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"PNG to PDF", pos = wx.DefaultPosition, size = wx.Size( 575,300 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		self.m_staticText2 = wx.StaticText( self, wx.ID_ANY, u"All files must be in the .PNG format.", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.DirPicker = wx.DirPickerCtrl( self, wx.ID_ANY, wx.EmptyString, u"Choose a folder", wx.DefaultPosition, wx.DefaultSize, wx.DIRP_DEFAULT_STYLE )
		...
		# Connect Events
		self.DirPicker.Bind( wx.EVT_DIRPICKER_CHANGED, self.TransformFile )
